...
export default function InfoBox({ attributes, context, handleTitleChange, handleDescriptionChange, handleButtonTextChange }) {
    ...
    const { borderType, borderColor, borderWidth, boxShadow, iconSize, titleFontSize } = styles
    ...
    return (
        ...
        <div {...blockProps}>
            ...
            >
                {icon.url ? <img src={icon.url} alt='icon' height={iconSize ?? 45} width={iconSize ?? 45} /> : <Airplane iconSize={iconSize} />}
                <RichText
                ...
                />
                <RichText
                    style={{ textAlign: contentAlignment, fontSize: "14px", color: "#757575" }}
